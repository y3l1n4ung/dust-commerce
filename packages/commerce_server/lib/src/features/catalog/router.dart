...
Router catalogRoutes(CatalogRepository repository) {
  return Router()
    ..route('/products', get(listProductsHandler(repository)))
    ..route('/products/{handle}', get(getProductHandler(repository)));
}
